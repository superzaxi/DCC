...
#undef agent_universe//ScenSim-Port//
struct universe agent_universe;
//ScenSim-Port//static struct option agent_options[] = {
struct option agent_options_template[AGENT_OPTIONS_NUM] = {//ScenSim-Port//
...
#define agent_universe SCENSIMGLOBAL(agent_universe)//ScenSim-Port//
#define agent_options SCENSIMGLOBAL(agent_options)//ScenSim-Port//

#undef server_universe//ScenSim-Port//
struct universe server_universe;
//ScenSim-Port//static struct option server_options[] = {
struct option server_options_template[SERVER_OPTIONS_NUM] = {//ScenSim-Port//
...
#define server_universe SCENSIMGLOBAL(server_universe)//ScenSim-Port//
...
//ScenSim-Port//	agent_universe.index = universe_count++;
	agent_universe.index = universe_count_++;//ScenSim-Port//
...
//ScenSim-Port//	universes [agent_universe.index] = &agent_universe;
	universes_ [agent_universe.index] = &agent_universe;//ScenSim-Port//
...
//ScenSim-Port//	server_universe.index = universe_count++;
	server_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//	universes [server_universe.index] = &server_universe;
	universes_ [server_universe.index] = &server_universe;//ScenSim-Port//
