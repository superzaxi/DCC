...
//ScenSim-Port//	return (server_duid.data != NULL);
	return (isc_boolean_t)(server_duid.data != NULL);//ScenSim-Port//
}
...
//ScenSim-Port//				  "attach lease to new IA: %s",
//ScenSim-Port//				  isc_result_totext(status));
				  "attach lease to new IA: %i", status);//ScenSim-Port//
		}
...
//ScenSim-Port//				  "attach prefix to new IA_PD: %s",
//ScenSim-Port//				  isc_result_totext(status));
				  "attach prefix to new IA_PD: %i", status);//ScenSim-Port//
		}
...
//ScenSim-Port//		   void (*ia_na_match)(),
//ScenSim-Port//		   void (*ia_na_nomatch)())
		   void (*ia_na_match)(const struct data_string*, const struct data_string*, struct iasubopt*),//ScenSim-Port//
		   void (*ia_na_nomatch)(const struct data_string*, const struct data_string*, u_int32_t*, struct packet*, char*, int*, int))//ScenSim-Port//
{
	struct option_state *opt_state;
...
iterate_over_ia_pd(struct data_string *reply_ret, 
		   ...
		   const struct data_string *server_id,
		   const char *packet_type,
//ScenSim-Port//		   void (*ia_pd_match)(),
//ScenSim-Port//		   void (*ia_pd_nomatch)())
		   void (*ia_pd_match)(const struct data_string*, const struct data_string*, struct iasubopt*),//ScenSim-Port//
		   void (*ia_pd_nomatch)(const struct data_string*, const struct data_string*, u_int32_t*, struct packet*, char*, int*, int))//ScenSim-Port//
{
