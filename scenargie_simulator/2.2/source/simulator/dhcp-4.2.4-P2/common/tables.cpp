...
#undef dhcp_universe//ScenSim-Port//
struct universe dhcp_universe;
//ScenSim-Port//static struct option dhcp_options[] = {
struct option dhcp_options_template[DHCP_OPTIONS_NUM] = {//ScenSim-Port//
...
#define dhcp_universe SCENSIMGLOBAL(dhcp_universe)//ScenSim-Port//

#undef nwip_universe//ScenSim-Port//
struct universe nwip_universe;
//ScenSim-Port//static struct option nwip_options[] = {
struct option nwip_options_template[NWIP_OPTIONS_NUM] = {//ScenSim-Port//
...
#define nwip_universe SCENSIMGLOBAL(nwip_universe)//ScenSim-Port//
...
#undef fqdn_universe//ScenSim-Port//
struct universe fqdn_universe;
//ScenSim-Port//struct universe fqdn6_universe;
//ScenSim-Port//static struct option fqdn_options[] = {
struct option fqdn_options_template[FQDN_OPTIONS_NUM] = {//ScenSim-Port//
...
#define fqdn_universe SCENSIMGLOBAL(fqdn_universe)//ScenSim-Port//

#undef vendor_class_universe//ScenSim-Port//
struct universe vendor_class_universe;
//ScenSim-Port//static struct option vendor_class_options[] =  {
struct option vendor_class_options_template[VENDOR_CLASS_OPTIONS_NUM] =  {//ScenSim-Port//
	{ "isc", "X",			&vendor_class_universe,      2495, 1 },
	{ NULL, NULL, NULL, 0, 0 }
};
#define vendor_class_universe SCENSIMGLOBAL(vendor_class_universe)//ScenSim-Port//

#undef vendor_universe//ScenSim-Port//
struct universe vendor_universe;
//ScenSim-Port//static struct option vendor_options[] = {
struct option vendor_options_template[VENDOR_OPTIONS_NUM] = {//ScenSim-Port//
	{ "isc", "Eisc.",		&vendor_universe,            2495, 1 },
	{ NULL, NULL, NULL, 0, 0 }
};
#define vendor_universe SCENSIMGLOBAL(vendor_universe)//ScenSim-Port//

#undef isc_universe//ScenSim-Port//
struct universe isc_universe;
//ScenSim-Port//static struct option isc_options [] = {
struct option isc_options_template[ISC_OPTIONS_NUM] = {//ScenSim-Port//
	{ "media", "t",				&isc_universe,   1, 1 },
	{ "update-assist", "X",			&isc_universe,   2, 1 },
	{ NULL,	NULL, NULL, 0, 0 }
};
#define isc_universe SCENSIMGLOBAL(isc_universe)//ScenSim-Port//

#undef dhcpv6_universe//ScenSim-Port//
struct universe dhcpv6_universe;
//ScenSim-Port//static struct option dhcpv6_options[] = {
struct option dhcpv6_options_template[DHCPV6_OPTIONS_NUM] = {//ScenSim-Port//
...
#define dhcpv6_universe SCENSIMGLOBAL(dhcpv6_universe)//ScenSim-Port//
...
#undef vsio_universe//ScenSim-Port//
struct universe vsio_universe;
//ScenSim-Port//static struct option vsio_options[] = {
struct option vsio_options_template[VSIO_OPTIONS_NUM] = {//ScenSim-Port//
	{ "isc", "Eisc6.",		&vsio_universe,		     2495, 1 },
	{ NULL, NULL, NULL, 0, 0 }
};
#define vsio_universe SCENSIMGLOBAL(vsio_universe)//ScenSim-Port//

#undef isc6_universe//ScenSim-Port//
struct universe isc6_universe;
//ScenSim-Port//static struct option isc6_options[] = {
struct option isc6_options_template[ISC6_OPTIONS_NUM] = {//ScenSim-Port//
	{ "media", "t",				&isc6_universe,     1, 1 },
	{ "update-assist", "X",			&isc6_universe,	    2, 1 },
	{ NULL, NULL, NULL, 0, 0 }
};
#define isc6_universe SCENSIMGLOBAL(isc6_universe)//ScenSim-Port//
...
//ScenSim-Port//universe_hash_t *universe_hash;
...
//ScenSim-Port//struct universe *config_universe;
...
//ScenSim-Port//char *default_option_format = (char *) "X";
const char *default_option_format = (char *) "X";//ScenSim-Port//
...
//ScenSim-Port//	universes = dmalloc(i, MDL);
//ScenSim-Port//	universes = (universe**)dmalloc(i, MDL);//ScenSim-Port//
	universes_ = (universe**)dmalloc(i, MDL);//ScenSim-Port////ScenSim-Port//
//ScenSim-Port//	if (universes == NULL)
	if (universes_ == NULL)//ScenSim-Port//
		log_fatal("Can't allocate option space table.");
//ScenSim-Port//	memset(universes, 0, i);
	memset(universes_, 0, i);//ScenSim-Port//
...
//ScenSim-Port//	dhcp_universe.index = universe_count++;
	dhcp_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//	universes [dhcp_universe.index] = &dhcp_universe;
	universes_ [dhcp_universe.index] = &dhcp_universe;//ScenSim-Port//
...
//ScenSim-Port//	nwip_universe.index = universe_count++;
	nwip_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//	universes [nwip_universe.index] = &nwip_universe;
	universes_ [nwip_universe.index] = &nwip_universe;//ScenSim-Port//
	...
	fqdn_universe.end = 0;
//ScenSim-Port//	fqdn_universe.index = universe_count++;
	fqdn_universe.index = universe_count_++;//ScenSim-Port//
	code = DHO_FQDN;
...
//ScenSim-Port//	universes [fqdn_universe.index] = &fqdn_universe;
	universes_ [fqdn_universe.index] = &fqdn_universe;//ScenSim-Port//
...
//ScenSim-Port//        vendor_class_universe.index = universe_count++;
        vendor_class_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//        universes[vendor_class_universe.index] = &vendor_class_universe;
        universes_[vendor_class_universe.index] = &vendor_class_universe;//ScenSim-Port//
...
//ScenSim-Port//        vendor_universe.index = universe_count++;
        vendor_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//        universes[vendor_universe.index] = &vendor_universe;
        universes_[vendor_universe.index] = &vendor_universe;//ScenSim-Port//
...
//ScenSim-Port//        isc_universe.index = universe_count++;
        isc_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//        universes[isc_universe.index] = &isc_universe;
        universes_[isc_universe.index] = &isc_universe;//ScenSim-Port//
...
//ScenSim-Port//	dhcpv6_universe.index = universe_count++;
	dhcpv6_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//	universes[dhcpv6_universe.index] = &dhcpv6_universe;
	universes_[dhcpv6_universe.index] = &dhcpv6_universe;//ScenSim-Port//
...
//ScenSim-Port//	vsio_universe.index = universe_count++;
	vsio_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//	universes[vsio_universe.index] = &vsio_universe;
	universes_[vsio_universe.index] = &vsio_universe;//ScenSim-Port//
	...
	if (!option_code_hash_lookup(&isc6_universe.enc_opt,
		...
		log_fatal("Unable to find ISC parent option (%s:%d).", MDL);
//ScenSim-Port//	isc6_universe.index = universe_count++;
	isc6_universe.index = universe_count_++;//ScenSim-Port//
//ScenSim-Port//	universes[isc6_universe.index] = &isc6_universe;
	universes_[isc6_universe.index] = &isc6_universe;//ScenSim-Port//
...
//ScenSim-Port//	fqdn6_universe.index = universe_count++;
	fqdn6_universe.index = universe_count_++;//ScenSim-Port//
	...
	if (!option_code_hash_lookup(&fqdn6_universe.enc_opt,
		...
		log_fatal("Unable to find FQDN v6 parent option. (%s:%d).",
			  MDL);
//ScenSim-Port//	universes[fqdn6_universe.index] = &fqdn6_universe;
	universes_[fqdn6_universe.index] = &fqdn6_universe;//ScenSim-Port//
