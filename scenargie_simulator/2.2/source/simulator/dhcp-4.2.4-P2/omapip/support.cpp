...
//ScenSim-Port//omapi_object_type_t *omapi_type_connection;
//ScenSim-Port//omapi_object_type_t *omapi_type_listener;
//ScenSim-Port//omapi_object_type_t *omapi_type_io_object;
//ScenSim-Port//omapi_object_type_t *omapi_type_datagram;
//ScenSim-Port//omapi_object_type_t *omapi_type_generic;
//ScenSim-Port//omapi_object_type_t *omapi_type_protocol;
//ScenSim-Port//omapi_object_type_t *omapi_type_protocol_listener;
//ScenSim-Port//omapi_object_type_t *omapi_type_waiter;
//ScenSim-Port//omapi_object_type_t *omapi_type_remote;
//ScenSim-Port//omapi_object_type_t *omapi_type_message;
//ScenSim-Port//omapi_object_type_t *omapi_type_auth_key;

//ScenSim-Port//omapi_object_type_t *omapi_object_types;
//ScenSim-Port//int omapi_object_type_count;
...
//ScenSim-Port//	status = omapi_object_type_register (&omapi_type_listener,
//ScenSim-Port//					     "listener",
//ScenSim-Port//					     omapi_listener_set_value,
//ScenSim-Port//					     omapi_listener_get_value,
//ScenSim-Port//					     omapi_listener_destroy,
//ScenSim-Port//					     omapi_listener_signal_handler,
//ScenSim-Port//					     omapi_listener_stuff_values,
//ScenSim-Port//					     0, 0, 0, 0, 0, 0,
//ScenSim-Port//					     sizeof (omapi_listener_object_t),
//ScenSim-Port//					     0, RC_MISC);
//ScenSim-Port//	if (status != ISC_R_SUCCESS)
//ScenSim-Port//		return status;

//ScenSim-Port//	status = omapi_object_type_register (&omapi_type_io_object,
//ScenSim-Port//					     "io",
//ScenSim-Port//					     omapi_io_set_value,
//ScenSim-Port//					     omapi_io_get_value,
//ScenSim-Port//					     omapi_io_destroy,
//ScenSim-Port//					     omapi_io_signal_handler,
//ScenSim-Port//					     omapi_io_stuff_values,
//ScenSim-Port//					     0, 0, 0, 0, 0, 0,
//ScenSim-Port//					     sizeof (omapi_io_object_t),
//ScenSim-Port//					     0, RC_MISC);
//ScenSim-Port//	if (status != ISC_R_SUCCESS)
//ScenSim-Port//		return status;
...
//ScenSim-Port//	status = omapi_object_type_register (&omapi_type_protocol,
//ScenSim-Port//					     "protocol",
//ScenSim-Port//					     omapi_protocol_set_value,
//ScenSim-Port//					     omapi_protocol_get_value,
//ScenSim-Port//					     omapi_protocol_destroy,
//ScenSim-Port//					     omapi_protocol_signal_handler,
//ScenSim-Port//					     omapi_protocol_stuff_values,
//ScenSim-Port//					     0, 0, 0, 0, 0, 0,
//ScenSim-Port//					     sizeof (omapi_protocol_object_t),
//ScenSim-Port//					     0, RC_MISC);
//ScenSim-Port//	if (status != ISC_R_SUCCESS)
//ScenSim-Port//		return status;

//ScenSim-Port//	status = (omapi_object_type_register
//ScenSim-Port//		  (&omapi_type_protocol_listener, "protocol-listener",
//ScenSim-Port//		   omapi_protocol_listener_set_value,
//ScenSim-Port//		   omapi_protocol_listener_get_value,
//ScenSim-Port//		   omapi_protocol_listener_destroy,
//ScenSim-Port//		   omapi_protocol_listener_signal,
//ScenSim-Port//		   omapi_protocol_listener_stuff,
//ScenSim-Port//		   0, 0, 0, 0, 0, 0,
//ScenSim-Port//		   sizeof (omapi_protocol_listener_object_t), 0, RC_MISC));
//ScenSim-Port//	if (status != ISC_R_SUCCESS)
//ScenSim-Port//		return status;

//ScenSim-Port//	status = omapi_object_type_register (&omapi_type_message,
//ScenSim-Port//					     "message",
//ScenSim-Port//					     omapi_message_set_value,
//ScenSim-Port//					     omapi_message_get_value,
//ScenSim-Port//					     omapi_message_destroy,
//ScenSim-Port//					     omapi_message_signal_handler,
//ScenSim-Port//					     omapi_message_stuff_values,
//ScenSim-Port//					     0, 0, 0, 0, 0, 0,
//ScenSim-Port//					     sizeof (omapi_message_object_t),
//ScenSim-Port//					     0, RC_MISC);
//ScenSim-Port//	if (status != ISC_R_SUCCESS)
//ScenSim-Port//		return status;

//ScenSim-Port//	status = omapi_object_type_register (&omapi_type_waiter,
//ScenSim-Port//					     "waiter",
//ScenSim-Port//					     0,
//ScenSim-Port//					     0,
//ScenSim-Port//					     0,
//ScenSim-Port//					     omapi_waiter_signal_handler, 0,
//ScenSim-Port//					     0, 0, 0, 0, 0, 0,
//ScenSim-Port//					     sizeof (omapi_waiter_object_t),
//ScenSim-Port//					     0, RC_MISC);
//ScenSim-Port//	if (status != ISC_R_SUCCESS)
//ScenSim-Port//		return status;

//ScenSim-Port//	status = omapi_object_type_register (&omapi_type_auth_key,
//ScenSim-Port//					     "authenticator",
//ScenSim-Port//					     0,
//ScenSim-Port//					     omapi_auth_key_get_value,
//ScenSim-Port//					     omapi_auth_key_destroy,
//ScenSim-Port//					     0,
//ScenSim-Port//					     omapi_auth_key_stuff_values,
//ScenSim-Port//					     omapi_auth_key_lookup,
//ScenSim-Port//					     0, 0, 0, 0, 0,
//ScenSim-Port//					     sizeof (omapi_auth_key_t), 0,
//ScenSim-Port//					     RC_MISC);
//ScenSim-Port//	if (status != ISC_R_SUCCESS)
//ScenSim-Port//		return status;

//ScenSim-Port//#if defined (TRACING)
//ScenSim-Port//	omapi_listener_trace_setup ();
//ScenSim-Port//	omapi_connection_trace_setup ();
//ScenSim-Port//	omapi_buffer_trace_setup ();
//ScenSim-Port//#endif
...
//ScenSim-Port//	t = dmalloc (sizeof *t, MDL);
	t = (omapi_object_type_t*)dmalloc (sizeof *t, MDL);//ScenSim-Port//
	if (!t)
...
//ScenSim-Port//		log_info ("omapi_set_value (%.*s, NULL)",
//ScenSim-Port//			  (int)name -> len, name -> value);
//ScenSim-Port//	} else if (value -> type == omapi_datatype_int) {
//ScenSim-Port//		log_info ("omapi_set_value (%.*s, %ld)",
//ScenSim-Port//			  (int)name -> len, name -> value,
//ScenSim-Port//			  (long)value -> u.integer);
//ScenSim-Port//	} else if (value -> type == omapi_datatype_string) {
//ScenSim-Port//		log_info ("omapi_set_value (%.*s, %.*s)",
//ScenSim-Port//			  (int)name -> len, name -> value,
//ScenSim-Port//			  (int)value -> u.buffer.len, value -> u.buffer.value);
//ScenSim-Port//	} else if (value -> type == omapi_datatype_data) {
//ScenSim-Port//		log_info ("omapi_set_value (%.*s, %ld %lx)",
//ScenSim-Port//			  (int)name -> len, name -> value,
//ScenSim-Port//			  (long)value -> u.buffer.len,
//ScenSim-Port//			  (unsigned long)value -> u.buffer.value);
//ScenSim-Port//	} else if (value -> type == omapi_datatype_object) {
//ScenSim-Port//		log_info ("omapi_set_value (%.*s, %s)",
//ScenSim-Port//			  (int)name -> len, name -> value,
//ScenSim-Port//			  value -> u.object
//ScenSim-Port//			  ? (value -> u.object -> type
//ScenSim-Port//			     ? value -> u.object -> type -> name
//ScenSim-Port//			     : "(unknown object)")
//ScenSim-Port//			  : "(unknown object)");
//ScenSim-Port//	}
//ScenSim-Port//#endif
	...
	if (outer -> type -> set_value)
		...
		status = ISC_R_NOTFOUND;
//ScenSim-Port//#if defined (DEBUG)
//ScenSim-Port//	log_info (" ==> %s", isc_result_totext (status));
//ScenSim-Port//#endif
	return status;
}
