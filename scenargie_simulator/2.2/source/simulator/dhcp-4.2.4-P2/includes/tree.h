...
struct binding_value {
	...
	enum {
		...
		binding_dns,
		binding_function
#define binding_boolean binding_value::binding_boolean//ScenSim-Port//
#define binding_data binding_value::binding_data//ScenSim-Port//
#define binding_numeric binding_value::binding_numeric//ScenSim-Port//
#define binding_dns binding_value::binding_dns//ScenSim-Port//
#define binding_function binding_value::binding_function//ScenSim-Port//
	} type;
	union value {
...
//ScenSim-Port//		struct expression *and [2];
		struct expression *and_ [2];//ScenSim-Port//
//ScenSim-Port//		struct expression *or [2];
		struct expression *or_ [2];//ScenSim-Port//
//ScenSim-Port//		struct expression *not;
		struct expression *not_;//ScenSim-Port//
