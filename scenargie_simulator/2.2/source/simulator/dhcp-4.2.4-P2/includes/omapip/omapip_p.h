...
//ScenSim-Port//#include <omapip/trace.h>
...
typedef struct __omapi_connection_object {
	...
	omapi_listener_object_t *listener;	/* Listener that accepted this
						   connection, if any. */
//ScenSim-Port//	dst_key_t *in_key;	/* Authenticator signing incoming
//ScenSim-Port//				   data. */
	void *in_context;	/* Input hash context. */
//ScenSim-Port//	dst_key_t *out_key;	/* Authenticator signing outgoing
//ScenSim-Port//				   data. */
