...
//ScenSim-Port//#include <sys/types.h>
#endif
//ScenSim-Port//#include <stddef.h>
//ScenSim-Port//#include <fcntl.h>
//ScenSim-Port//#include <stdio.h>
//ScenSim-Port//#include <unistd.h>
//ScenSim-Port//#include <string.h>
//ScenSim-Port//#include <stdlib.h>
//ScenSim-Port//#include <sys/stat.h>
//ScenSim-Port//#include <sys/mman.h>
//ScenSim-Port//#include <ctype.h>
//ScenSim-Port//#include <time.h>

//ScenSim-Port//#include <net/if.h>
#undef FDDI
//ScenSim-Port//#include <net/route.h>
//ScenSim-Port//#include <net/if_arp.h>
#if HAVE_NET_IF_DL_H
//ScenSim-Port//# include <net/if_dl.h>
#endif

//ScenSim-Port//#include <setjmp.h>

//ScenSim-Port//#include "cdefs.h"
//ScenSim-Port//#include "osdep.h"
...
//ScenSim-Port//# include <ldap.h>
//ScenSim-Port//# include <sys/utsname.h> /* for uname() */
#endif
...
#endif
	int class_count;
//ScenSim-Port//	struct class *classes [PACKET_MAX_CLASSES];
	struct class_type *classes [PACKET_MAX_CLASSES];//ScenSim-Port//
...
struct lease {
	...
	struct pool *pool;
//ScenSim-Port//	struct class *billing_class;
	struct class_type *billing_class;//ScenSim-Port//
...
struct permit {
	...
	enum {
		...
		permit_class,
		permit_after
#define permit_unknown_clients permit::permit_unknown_clients//ScenSim-Port//
#define permit_known_clients permit::permit_known_clients//ScenSim-Port//
#define permit_authenticated_clients permit::permit_authenticated_clients//ScenSim-Port//
#define permit_unauthenticated_clients permit::permit_unauthenticated_clients//ScenSim-Port//
#define permit_all_clients permit::permit_all_clients//ScenSim-Port//
#define permit_dynamic_bootp_clients permit::permit_dynamic_bootp_clients//ScenSim-Port//
#define permit_class permit::permit_class//ScenSim-Port//
#define permit_after permit::permit_after//ScenSim-Port//
	} type;
//ScenSim-Port//	struct class *class;
	struct class_type *class_;//ScenSim-Port//
...
struct collection {
	...
	const char *name;
//ScenSim-Port//	struct class *classes;
	struct class_type *classes;//ScenSim-Port//
};
...
//ScenSim-Port//struct class {
struct class_type {//ScenSim-Port//
	OMAPI_OBJECT_PREAMBLE;
//ScenSim-Port//	struct class *nic;		/* Next in collection. */
	struct class_type *nic;		/* Next in collection. *///ScenSim-Port//
//ScenSim-Port//	struct class *superclass;	/* Set for spawned classes only. */
	struct class_type *superclass;	/* Set for spawned classes only. *///ScenSim-Port//
...
//ScenSim-Port//	struct client_lease *new;			       /* New lease. */
	struct client_lease *new_;			       /* New lease. *///ScenSim-Port//
...
struct timeout {
	...
	tvref_t ref;
	tvunref_t unref;
//ScenSim-Port//	isc_timer_t *isc_timeout;
};
...
//ScenSim-Port//	u_int16_t class;		/* Class of query. */
	u_int16_t class_;		/* Class of query. *///ScenSim-Port//
	unsigned char data [1];		/* Query data. */
};

struct dns_answer {
	u_int16_t type;			/* Type of answer. */
//ScenSim-Port//	u_int16_t class;		/* Class of answer. */
	u_int16_t class_;		/* Class of answer. *///ScenSim-Port//
...
//ScenSim-Port//	isc_sockaddrlist_t zone_server_list;
//ScenSim-Port//	isc_sockaddr_t zone_addrs[DHCP_MAXNS];
	int zone_addr_count;
...
//ScenSim-Port//HASH_FUNCTIONS_DECL (class, const char *, struct class, class_hash_t)
HASH_FUNCTIONS_DECL (class, const char *, struct class_type, class_hash_t)//ScenSim-Port//
...
//ScenSim-Port//		 struct option_cache *, enum statement_op);
		 struct option_cache *, enum statement_op);//ScenSim-Port//
...
//ScenSim-Port//int parse_class_declaration (struct class **, struct parse *,
int parse_class_declaration (struct class_type **, struct parse *,//ScenSim-Port//
			     struct group *, int);
...
int parse_option_statement (struct executable_statement **,
			    struct parse *, int,
//ScenSim-Port//			    struct option *, enum statement_op);
			    struct option *, enum statement_op);//ScenSim-Port//
...
int client_parse_allow_deny (struct option_cache **, struct parse *, int);//ScenSim-Port//
...
void client_dhcp (struct packet *);//ScenSim-Port//
...
void client_dhcpv6(struct packet *);//ScenSim-Port//

/* bootp.c */
void bootp (struct packet *);
void client_bootp (struct packet *);//ScenSim-Port//
...
//ScenSim-Port//OMAPI_OBJECT_ALLOC_DECL (class, struct class, dhcp_type_class)
OMAPI_OBJECT_ALLOC_DECL (class, struct class_type, dhcp_type_class)//ScenSim-Port//
//ScenSim-Port//OMAPI_OBJECT_ALLOC_DECL (subclass, struct class, dhcp_type_subclass)
OMAPI_OBJECT_ALLOC_DECL (subclass, struct class_type, dhcp_type_subclass)//ScenSim-Port//
...
/* tables.c */
//ScenSim-Port//extern char *default_option_format;
extern const char *default_option_format;//ScenSim-Port//
...
//ScenSim-Port//int write_billing_class (struct class *);
int write_billing_class (struct class_type *);//ScenSim-Port//
...
//ScenSim-Port//void convert_host_statement (struct parse *, jrefproto);
//ScenSim-Port//void convert_host_name (struct parse *, jrefproto);
//ScenSim-Port//void convert_class_statement (struct parse *, jrefproto, int);
//ScenSim-Port//void convert_class_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_lease_time (struct parse *, jrefproto, char *);
//ScenSim-Port//void convert_shared_net_statement (struct parse *, jrefproto);
//ScenSim-Port//void convert_subnet_statement (struct parse *, jrefproto);
//ScenSim-Port//void convert_subnet_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_host_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_hardware_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_hardware_addr (struct parse *, jrefproto);
//ScenSim-Port//void convert_filename_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_servername_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_ip_addr_or_hostname (struct parse *, jrefproto, int);
//ScenSim-Port//void convert_fixed_addr_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_option_decl (struct parse *, jrefproto);
//ScenSim-Port//void convert_lease_statement (struct parse *, jrefproto);
//ScenSim-Port//void convert_address_range (struct parse *, jrefproto);
//ScenSim-Port//void convert_date (struct parse *, jrefproto, char *);
//ScenSim-Port//void convert_numeric_aggregate (struct parse *, jrefproto, int, int, int, int);
void indent (int);
...
//ScenSim-Port//struct class unknown_class;
//ScenSim-Port//struct class known_class;
//ScenSim-Port//struct collection default_collection;
//ScenSim-Port//struct collection *collections;
extern struct collection *collections;//ScenSim-Port//
...
int client_check_collection (struct packet *, struct lease *, struct collection *);//ScenSim-Port//
//ScenSim-Port//void classify (struct packet *, struct class *);
void classify (struct packet *, struct class_type *);//ScenSim-Port//
void client_classify (struct packet *, struct class_type *);//ScenSim-Port//
//ScenSim-Port//isc_result_t unlink_class (struct class **class);
isc_result_t unlink_class (struct class_type **class_arg);//ScenSim-Port//
//ScenSim-Port//isc_result_t find_class (struct class **, const char *,
//ScenSim-Port//			 const char *, int);
isc_result_t find_class (struct class_type **, const char *, const char *, int);//ScenSim-Port//
isc_result_t client_find_class (struct class_type **, const char *, const char *, int);//ScenSim-Port//
//ScenSim-Port//int unbill_class (struct lease *, struct class *);
int unbill_class (struct lease *, struct class_type *);//ScenSim-Port//
//ScenSim-Port//int bill_class (struct lease *, struct class *);
int bill_class (struct lease *, struct class_type *);//ScenSim-Port//
...
//ScenSim-Port//isc_result_t enter_class (struct class *, int, int);
isc_result_t enter_class (struct class_type *, int, int);//ScenSim-Port//
//ScenSim-Port//isc_result_t delete_class (struct class *, int);
isc_result_t delete_class (struct class_type *, int);//ScenSim-Port//
...
//ScenSim-Port//int find_subclass_in_ldap (struct class *, struct class **,
int find_subclass_in_ldap (struct class_type *, struct class_type **,//ScenSim-Port//
			   struct data_string *);
#endif
